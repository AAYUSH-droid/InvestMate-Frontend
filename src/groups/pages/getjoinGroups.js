    ...
    () => [
      {
        ...
        columns: [
          ...
          },
          {
            ...
            accessor: '_id',
            Cell: (e) => (
              <NavLink className='join_group_link' to={`/group/${e.value}`}>
                {' '}
                Click here{' '}
              </NavLink>
            ),
    ...
    const fetchUsers = async () => {
      try {
        ...
        const responseData = await sendRequest(
          `https://invest-mate-backend.vercel.app/api/groups/getjoingroups/${userId}`,
          'POST'
        );
    ...
    <Fragment>
      <div className='group_form_div'>
        <center>
          ...
          >
            <h2 className='search_head'>Filter Groups</h2>
            <hr />
