  ...
  const onSubmitform = async (e) => {
    ...
    try {
      ...
      const responseData = await sendRequest(
        `https://invest-mate-backend.vercel.app/api/source/add/${gid}/${userId}`,
        'POST',
        body,
        {
    ...
    <React.Fragment>
      ...
      <div className='group_form_div'>
        <center>
          ...
          >
            {/* form header */}
            <h2 className='request_heading'>ADD SOURCE</h2>
            <hr />
            ...
            <br />
            <br />
            <label className='labels'>Market Place</label>
            <br />
            <input
              type='text'
              name='marketplace'
            ...
            <input
              ...
              className='request_inputs'
              value={targetPrice}
              onChange={(e) => setTragetprice(e.target.value)}
              required
            />
            <br />
            <br />
            ...
            <input
              ...
              className='request_inputs'
              value={unitsPurchase}
              onChange={(e) => setUnitspurchase(e.target.value)}
              required
            />
            <br />
            <br />
