  ...
  const onSubmitform = async (e) => {
    ...
    try {
      ...
      const responseData = await sendRequest(
        `https://invest-mate-backend.vercel.app/api/source/delete/sources/${sid}/${userId}/`,
        'POST',
        body,
        {
    ...
    <React.Fragment>
      ...
      <div className='group_form_div'>
        <center>
          ...
          >
            {/* form header */}
            <h2 className='form_heading'>Selling Price of the source</h2>{' '}
            ...
            <input
              ...
              value={sellingPrice}
              placeholder='Selling Price of Each unit'
