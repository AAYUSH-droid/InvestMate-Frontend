  ...
  const onSubmitform = async (e) => {
    ...
    try {
      ...
      const responseData = await sendRequest(
        `https://invest-mate-backend.vercel.app/api/groups/create/${userId}`,
        'POST',
        body,
        {
    ...
    <React.Fragment>
      ...
      <div className='group_form_div'>
        <center>
          ...
          >
            <h2 className='form_heading'>Create a New Group</h2>
            <hr />
            ...
            <textarea
              ...
              rows='7'
              cols='45'
              placeholder='Give a brief insight of your past acheivements '
            ...
            <input
              ...
              step='50'
              min='50'
              placeholder='Starting value of Min Amount:Rs 50'
